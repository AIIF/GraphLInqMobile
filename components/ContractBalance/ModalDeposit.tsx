...
import { Button, Icon, Text, Alert, Modal, NumberDecrementStepper, NumberIncrementStepper, NumberInput, NumberInputField, NumberInputStepper, Stack, useDisclose } from 'native-base';
...
export const ModalDeposit: React.FC<ModalDepositProps> = ({ }) => {
    ...
    return (
        <>
            ...
            <Modal finalFocusRef={finalRef as any} isOpen={isOpen} onClose={onClose} key="test">
                <Modal.Content className="mod mod-dep">
                    <header><h2>Cloud Balance Deposit</h2></header>
                    <Modal.CloseButton className="clo" />
                    <Modal.Body class="fred">
                        <Stack m={'3'} p="4">
                            {error &&
                            <Alert status="error">
